...
exports.CreateQuestionnaire1771110237354 = void 0;
class CreateQuestionnaire1771110237354 {
    ...
    `);
        const groupHOptions = [
            ...
            { text: 'Persistência/falha de cicatrização do alvéolo pós-extração', value: 'h_socket_healing_failure' },
            { text: 'Infecção local recorrente, supuração e sensibilidade gengival', value: 'h_recurrent_infection' },
            { text: 'Edema ou ulceração persistente da mucosa sem causa aparente', value: 'h_mucosal_edema_ulceration' },
...
exports.CreateQuestionnaire1771110237354 = CreateQuestionnaire1771110237354;
